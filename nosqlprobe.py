...
def enumerate_mongodb(host, port, creds, csvw=None):
    try:
        ...
        c = MongoClient(host=host, port=port, serverSelectionTimeoutMS=5000)
    except Exception as e:
...
def handle_web(args):
    ...
    tests = [
        ...
        ('single-quote','syntax single-quote', lambda _: "'"),
        ('sq-plus',   'syntax quote-plus', lambda _: "'+'"),
